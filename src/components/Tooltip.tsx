...
export default function Tooltip({ content, children, position = 'top' }: TooltipProps) {
  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div 
          className={`absolute z-50 px-4 py-3 text-sm font-medium text-white bg-gray-900 dark:bg-gray-700 rounded-lg shadow-lg transition-opacity duration-200 ${positionClasses[position]}`}
